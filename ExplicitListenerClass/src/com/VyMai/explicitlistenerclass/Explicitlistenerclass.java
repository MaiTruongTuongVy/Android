package com.VyMai.explicitlistenerclass;
...
public class Explicitlistenerclass extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_explicitlistenerclass);
        ...
        btngiaipt.setOnClickListener(new MyEvent());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.explicitlistenerclass, menu);
        return true;
    }
